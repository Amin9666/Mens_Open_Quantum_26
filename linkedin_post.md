...
One Round 2 match had already been played by the time I pulled the data: Khachanov over Auger-Aliassime. The fixed model called it 50.4% in Khachanov's favor — basically a coin flip, which is exactly what that match was.

Highest confidence picks for Round 2: Alcaraz (92%), Medvedev (94%), Learner Tien (86%).
